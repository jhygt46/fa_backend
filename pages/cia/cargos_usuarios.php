...
if(isset($_GET["id"]) && is_numeric($_GET["id"]) && $_GET["id"] != 0){
    ...
    $id_carg = $_GET["id"];
    $cargo = $fireapp->get_cargo_cia($id_carg);
    $list_user = $fireapp->get_usuarios_cia();
    $list_user_cargo = $fireapp->get_users_cargo_cia($id_carg);
    ...
    echo "LISTA DE USUARIOS QUE HAN SIDO ".$cargo['nombre']."<pre>";
    print_r($list_user_cargo);
    echo "</pre>";
    
    echo $cargo['nombre']." ACTUAL<pre>";
    print_r($actuales);
    echo "</pre>";
    /*
    echo "<pre>";
                ...
                <fieldset>
                    ...
                    <div class="parent_cargo" style="background: #d2d2d2; padding: 10px 0px 20px 0px; margin: 0px 20% 0px 5%;">
                        ...
                        <ul style="padding-bottom: 10px; font-size: 14px;" class="clearfix">
                            ...
                            <li style="float: left; width: 78%;"><?php echo $actuales[$i]['f_ini']; ?></li>
                        </ul>
            ...
            <ul class='listUser'>
                ...
                <li class="user">
                    <ul class="clearfix">
                        ...
                        <a title="Modificar" class="icn modificar" onclick="navlink('<?php echo $page_mod; ?>?id=<?php echo $id_carg; ?>&id_ucar=<?php echo $id; ?>')"></a>
                    </ul>
                </li>
