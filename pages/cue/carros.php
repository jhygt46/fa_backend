...
$fireapp = new Core();
$fireapp->seguridad_exit(array(4, 29));
...
<hr>
<?php if($fireapp->seguridad_if(array(4))){ ?>
<div class="info">
...
<?php } ?>
<?php if($fireapp->seguridad_if(array(1, 29))){ ?>
<div class="info">
    <div class="fc" id="info-0">
        <div class="minimizar m1"></div>
        <div class="close"></div>
            ...
            <ul class='listUser'>
                ...
                <li class="user">
                    <ul class="clearfix">
                        ...
                        <?php if($fireapp->seguridad_if(array(29))){ ?><a title="Eliminar" class="icn borrar" onclick="eliminar('<?php echo $eliminaraccion; ?>', <?php echo $id; ?>, '<?php echo $eliminarobjeto; ?>', '<?php echo $nombre; ?>')"></a><?php } ?>
                        <?php if($fireapp->seguridad_if(array(4))){ ?><a title="Modificar" class="icn modificar" onclick="navlink('<?php echo $page_mod; ?>?id_car=<?php echo $id; ?>&id=<?php echo $id_cia; ?>&nombre=<?php echo $_GET["nombre"]; ?>')"></a><?php } ?>
                    </ul>
                </li>
