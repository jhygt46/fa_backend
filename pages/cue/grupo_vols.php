...
$fireapp->seguridad_exit(array(6, 33));
...
<hr>
<?php if($fireapp->seguridad_if(array(6))){ ?>
<div class="info">
...
<?php if($fireapp->seguridad_if(array(6, 33))){ ?>
<div class="info">
    <div class="fc" id="info-0">
        <div class="minimizar m1"></div>
        <div class="close"></div>
            ...
            <ul class='listUser'>
                ...
                <li class="user">
                    <ul class="clearfix">
                        ...
                        <?php if($fireapp->seguridad_if(array(33))){ ?><a title="Eliminar" class="icn borrar" onclick="eliminar('<?php echo $eliminaraccion; ?>', <?php echo $id; ?>, '<?php echo $eliminarobjeto; ?>', '<?php echo $nombre; ?>')"></a><?php } ?>
                        <?php if($fireapp->seguridad_if(array(6))){ ?><a title="Modificar" class="icn modificar" onclick="navlink('<?php echo $page_mod; ?>?id=<?php echo $id; ?>')"></a><?php } ?>
                    </ul>
                </li>
