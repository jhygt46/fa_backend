...
$claves_cue = $fireapp->get_claves_cue();

$titulo = "Actos de Cuerpo";
$titulo_list = "Proximos de Actos";
$sub_titulo1 = "Ingresar Acto";
$sub_titulo2 = "Modificar Acto";
$accion = "crearactocue";

$eliminaraccion = "eliminaractocue";
$id_list = "id_act";
$eliminarobjeto = "Acto";
$page_mod = "pages/actos_cue.php";
/* CONFIG PAGE */
...
if(isset($_GET["id"]) && is_numeric($_GET["id"]) && $_GET["id"] != 0){
    ...
    $that = $fireapp->get_acto_cue($_GET["id"]);
    $id = $_GET["id"];
                ...
                <fieldset>
                    ...
                    <label>
                        ...
                        <select id="clave">
                            ...
                            <?php for($i=0; $i<count($claves_cue); $i++){ ?>
                            <option value="<?php echo $claves_cue[$i]['id_cla']; ?>" <?php if($that['id_cla'] == $claves_cue[$i]['id_cla']){ echo "selected"; } ?>><?php echo $claves_cue[$i]['nombre']; ?></option>
                            <?php } ?>
                        </select>
                    </label>
                    <label>
