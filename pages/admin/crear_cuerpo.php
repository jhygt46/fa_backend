            ...
            <form action="" method="post" class="basic-grey">
                <fieldset>
                    ...
                    <label>
                        ...
                        <input id="nombreadmin" type="text" value="<?php echo $that['admin']; ?>" require="" placeholder="Ej: CBS" />
                        <div class="mensaje"></div>
                    </label>
                    <label>
                        <span>Correo Admin:</span>
                        <input id="correoadmin" type="text" value="<?php echo $that['admin']; ?>" require="" placeholder="Ej: CBS" />
                        <div class="mensaje"></div>
                    </label>
                    <?php } ?>
